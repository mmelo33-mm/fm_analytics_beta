...
with tab2:
    ...
    if tem_jogadores:
        ...
        df_agg["golos_90"]  = (df_agg["golos"]  / df_agg["minutos_total"] * 90).round(2)
        df_agg["xg_90"]     = (df_agg["xg_total"]/ df_agg["minutos_total"] * 90).round(2)
        df_agg["contrib_90"]= ((df_agg["golos"] + df_agg["assistencias"]) / df_agg["minutos_total"] * 90).round(2)
        df_agg["dist_90"]   = (df_agg["dist_total"] / df_agg["minutos_total"] * 90).round(2)
